...
export function ModalidadesScreen() {
  ...
  const active = modalidades.filter(m => m.situacao !== "DELETADO");
    ...
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{active.length} modalidade{active.length !== 1 ? "s" : ""} cadastrada{active.length !== 1 ? "s" : ""}</p>
        </div>
